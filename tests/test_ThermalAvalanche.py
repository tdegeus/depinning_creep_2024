...
from mycode_thermal_epm import ThermalAvalanche  # noqa: E402
...
class MyTests(unittest.TestCase):
    ...
    def test_basic(self):
        ...
        ThermalAvalanche.Run(["--dev", "id=0000_ava.h5"])
        ThermalAvalanche.Run(["--dev", "id=0000_ava.h5"])
        ThermalAvalanche.EnsembleInfo(["--dev", "id=0000_ava.h5", "--xc", 0.5])
